...
import { draftFromInput, draftFromJson, draftFromRecipe, draftToJson, emptyDraft, type RecipeDraft } from "../../src/components/RecipeForm";
  ...
  parts: [
    {
      ...
      steps: [{ id: "55555555-5555-4555-8555-555555555555", text: "Rub in.", ingredientIds: [] }],
    },
    {
      id: "77777777-7777-4777-8777-777777777777",
      name: "",
      ingredients: [],
      steps: [{ id: "66666666-6666-4666-8666-666666666666", text: "Bake.", ingredientIds: [] }],
    },
  ],
