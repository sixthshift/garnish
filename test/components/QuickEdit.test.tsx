...
import {
  ...
  withStepReplaced,
} from "../../src/components/QuickEdit";
import type { DraftIngredient } from "../../src/components/RecipeForm";
import type { Ingredient, Recipe, Unit } from "../../src/domain/recipe";
  ...
  parts: [
    {
      ...
      steps: [{ id: PASTRY_STEP, text: "Rub the butter in", ingredientIds: [] }],
    },
    {
      id: FILLING,
      name: "Filling",
      ingredients: [ingredient(FILLING_SUGAR, sugar, 100)],
      steps: [{ id: FILLING_STEP, text: "Whisk **well**", ingredientIds: [] }],
    },
  ],
