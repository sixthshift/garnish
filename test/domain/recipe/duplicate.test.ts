  ...
  parts: [
    {
      ...
      steps: [{ id: id(), text: "Rub in the butter.", title: "", summary: "", ingredientIds: [], image: null }],
    },
    { id: id(), name: "", ingredients: [], steps: [{ id: id(), text: "Serve cold.", title: "", summary: "", ingredientIds: [], image: null }] },
  ],
  restyledAt: null,
