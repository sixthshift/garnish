      ...
      ingredients: [
        {
          ...
          quantity: 50,
          unit: gram,
          food: { id: ids.butter, name: "butter", pluralName: null, aliases: [], aisle: { id: ids.dairy, name: "Dairy", position: 3 }, recipeId: null, skipShopping: false, conversions: [] },
          note: "cold, cubed",
        ...
        },
        {
          ...
          quantity: null,
          unit: null,
          food: { id: ids.salt, name: "salt", pluralName: null, aliases: ["sea salt"], aisle: null, recipeId: null, skipShopping: true, conversions: [] },
          note: "to taste",
          originalText: "salt to taste",
          fixed: false,
        },
      ],
      steps: [{ id: ids.step1, text: "Melt the butter over low heat.", ingredientIds: [], image: null }],
    },
    {
      id: ids.pasta,
      name: "Pasta",
      ingredients: [
        {
          ...
          quantity: 200,
          unit: gram,
          food: { id: ids.spaghetti, name: "spaghetti", pluralName: null, aliases: [], aisle: null, recipeId: null, skipShopping: false, conversions: [] },
          note: "",
      ...
      steps: [
        { id: ids.step2, text: "Boil until al dente.", ingredientIds: [], image: null },
        { id: ids.step3, text: "Toss the pasta through the butter and serve.", ingredientIds: [], image: null },
      ],
    },
  ],
  restyledAt: null,
