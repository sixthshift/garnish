...
import { type Ingredient, type Recipe } from "../../domain/recipe/recipe";
import { type ShoppingAddition, ingredientText, shoppingGroups, additionsForWithSubRecipes } from "../../domain/shopping/shopping";
