...
// `subRecipeScale` derives — `src/domain/shopping/shopping.ts`'s `subRecipeAdditions`
...
import { subRecipeAdditions, type ShoppingAddition, type ShoppingAdditionSource } from "../../domain/shopping/shopping";
import { subRecipeScale, type SubRecipe } from "../../domain/recipe/subRecipe";
 ...
 * instead of its own (`subRecipeAdditions`, src/domain/shopping/shopping.ts), using
