...
export function ChevronRight({ title }: { title?: string } = {}) {
  return (
    <svg
      width="16"
      height="16"
...
/** The pencil: the recipe page's Edit link at 16, QuickEdit's inline pencil at 14 with a title. */
export function PencilIcon({ size = 16, title }: { size?: number; title?: string } = {}) {
  return (
    <svg
      width={size}
      height={size}
