...
// unit (M32.2, src/domain/reference/convert.ts) merges too:
...
// recipe (M32.3, src/domain/recipe/subRecipe.ts). Choosing it swaps that one row for
 ...
 * src/domain/plan/plan.ts) uses one name shared by every row: the plan day rather
