...
- New recipe: `/recipes/new` goes straight to the blank editor. M23 puts a source chooser in front of it — a web page, or your own — and the paste box M19 briefly put here is gone (decisions.md row 57).
